...
Define portal's documentation system so detailed guidance lives in `docs/`,
...
Project documentation MUST describe portal operating modes, including tailnet-private and funnel-public usage, and MUST describe mock backend behavior independently from exposure mode.

#### Scenario: Tailnet mode behavior is documented
- **WHEN** a user reads operating mode documentation
- **THEN** the documentation explains tailnet-private default behavior and how to run `portal <port>`

#### Scenario: Funnel mode behavior is documented
- **WHEN** a user reads operating mode documentation
- **THEN** the documentation explains funnel opt-in behavior and how to run `portal <port> --funnel`
...
- **AND** the documentation states that `portal --mock` is tailnet-private by default
- **AND** the documentation includes explicit public mock guidance using `portal --mock --funnel`
